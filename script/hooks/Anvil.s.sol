...
import {EasyPosm} from "../../test/hooks/utils/EasyPosm.sol";
import {IAllowanceTransfer} from "permit2/src/interfaces/IAllowanceTransfer.sol";
import {DeployPermit2} from "../../test/hooks/utils/forks/DeployPermit2.sol";
...
contract UniLiquidHookScript is Script, DeployPermit2 {
    ...
    function run() public {
        ...
        // ----------------------------- //
        vm.broadcast();
        UniLiquidHook hook = new UniLiquidHook{salt: salt}(manager);
